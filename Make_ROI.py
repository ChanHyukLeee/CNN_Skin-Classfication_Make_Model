# USING A computer vision application for assessing facial acne severity from selfie images
# By Tingting Zhao, Hang Zhang, Jacob Spoelstra
#https://github.com/microsoft/nestle-acne-assessment/blob/master/notebooks/data_processing_demo.ipynb

Eye_Cascade_Path = '../models/haarcascade_eye.xml'
PREDICTOR_PATH = '../models/shape_predictor_68_face_landmarks.dat'
croppedFaces_Dir = '../cropped_face_dir'
originalFile_Dir = '../original_image_dir'
width_ratio = 1.5 
top_ratio = 1.5 
down_ratio = 4.5
